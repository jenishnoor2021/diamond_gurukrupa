            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="mb-3">
                     ...
                     <input type="text" name="party_code" class="form-control" id="party_code" placeholder="Enter party code" onkeypress='return (event.charCode != 32)' value="{{ old('party_code') }}" required>
            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="mb-3">
                     ...
                     <input type="number" name="{{ $roundpartyrang->key }}" class="form-control" id="{{ $roundpartyrang->key }}" placeholder="Enter amount" value="">
            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="mb-3">
                     ...
                     <input type="number" name="{{ $otherpartyrang->key }}" class="form-control" id="{{ $otherpartyrang->key }}" placeholder="Enter amount" value="">
