            ...
            <div class="row">
               <div class="col-md-4">
                  <div class="mb-3">
                     ...
                     <input type="text" name="shape_type" class="form-control" id="shape_type" placeholder="Enter name" onkeypress='return (event.charCode != 32)' value="{{$shape->shape_type}}" required>
