                ...
                <form action="{{ route('party.filter') }}" method="GET">
                    ...
                    <div data-repeater-list="group-a">
                        <div data-repeater-item class="row">
                            ...
                            <div class="mb-3 col-lg-2">
                                <label for="min_weight">Min Range:</label>
                                <input type="number" name="min_weight" class="form-control" id="min_weight"
                                    placeholder="Min" step="0.01" value="{{ request()->min_weight }}">
                                @if ($errors->has('min_weight'))
                                <div class="error text-danger">{{ $errors->first('min_weight') }}</div>
                                @endif
                            </div>

                            <div class="mb-3 col-lg-2">
                                <label for="max_weight">Max Range:</label>
                                <input type="number" name="max_weight" class="form-control" id="max_weight"
                                    placeholder="Max" step="0.01" value="{{ request()->max_weight }}">
                                @if ($errors->has('max_weight'))
                                <div class="error text-danger">{{ $errors->first('max_weight') }}</div>
                                @endif
                            </div>
